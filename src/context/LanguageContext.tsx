...
const translations = {
  ko: {
    ...
    "home.features.schools.description":
    ...
    "home.majors.natural.specializations":
      "생물학, 화학, 물리학, 수학, 환경과학",
    ...
    "profile.checklist.description":
      "완료했거나 가지고 있는 항목을 체크하세요. 지원 준비 상태를 확인하는 데 도움이 됩니다.\n모든 항목이 필수는 아니며 학교마다 요구 사항이 다를 수 있습니다.",
    ...
    "profile.extracurriculars.description.placeholder":
      "역할과 성과를 설명하세요...",
    "profile.extracurriculars.empty": "아직 추가된 대외활동이 없습니다.",
    "profile.extracurriculars.empty.action":
      '"활동 추가"를 클릭하여 시작하세요.',
    ...
    "housing.availability.notice":
      "현재 캘리포니아와 조지아주의 매물만 제공됩니다",
    "housing.search.title": "원하는 조건으로 간편하게 검색",
    "housing.search.description":
      "캘리포니아 또는 조지아 지역의 도시를 검색하세요",
    "housing.search.placeholder": "예: Los Angeles, Atlanta, Fresno, Savannah",
    "housing.search.error.invalid-state":
      "죄송합니다. 현재 캘리포니아(CA)와 조지아(GA)주의 매물만 이용 가능합니다.",
    "housing.search.error.examples":
      "예시: Fresno, Los Angeles, San Francisco (CA) • Atlanta, Savannah, Athens (GA)",
    ...
    "dashboard.improve.desc":
      "합격 가능성을 높이기 위해 이 영역을 개선하는 데 집중하세요.",
    "dashboard.improve.excellent":
      "훌륭합니다! 모든 영역에서 프로필이 강력해 보입니다.",
    ...
    "dashboard.profileHistory.title": "프로필 분석 이력",
    "dashboard.profileHistory.subtitle": "최근 입력한 프로필 정보입니다",
    "dashboard.profileHistory.academic": "학업 정보",
    "dashboard.profileHistory.extracurricular": "비교과 정보",
    "dashboard.profileHistory.total": "총점",
    "dashboard.profileHistory.courses": "과목",
    "dashboard.profileHistory.activities": "활동",
    "dashboard.profileHistory.recommendations": "추천서",
    "dashboard.profileHistory.letters": "통",
    "dashboard.profileHistory.positions": "역할",
    "dashboard.profileHistory.awards": "수상",
    "dashboard.profileHistory.awardsCount": "개",
    "dashboard.profileHistory.citizenship": "신분",
    "dashboard.profileHistory.domestic": "미국 학생",
    "dashboard.profileHistory.international": "유학생",
  },
  en: {
    // Navbar
    ...
    "map.subtitle":
      "Explore major U.S. universities and their tuition information at a glance",
    ...
    "home.hero.description":
      "Navigate complex admissions at a glance and get your personalized study plan.\nStart your successful U.S. college journey with PrepLounge.",
    ...
    "home.calculator.subtitle":
      "Enter your grades and check your profile score.",
    ...
    "home.calculator.description":
      "This is a simple calculation based on GPA and SAT scores.\nFor comprehensive analysis including extracurricular activities, essays,\nand personalized university recommendations, please complete your full profile.",
    "home.calculator.button": "Get Detailed Admission Analysis",

    // HomePage - Features
    "home.features.title": "Key Services",
    "home.features.subtitle":
      "PrepLounge provides diverse services for successful college admissions for international school students.",
    "home.features.schools.title": "School\nInformation",
    "home.features.schools.description":
      "View admission information for over 1,200 U.S. universities, including required documents and application deadlines.",
    "home.features.profile.title": "Personalized\nProfile Analysis",
    "home.features.profile.description":
      "AI analyzes your admission chances based on your grades and extracurricular activities.",
    "home.features.consulting.title": "Consulting Programs\nComparison",
    "home.features.consulting.description":
      "Compare domestic consulting academies and find the best programs to strengthen your profile.",
    "home.features.link": "Go →",

    // HomePage - Majors
    "home.majors.title": "Still Wondering About Your Major?",
    "home.majors.subtitle":
      "Find your ideal major with a simple test.\n* Average salary and employment rates are estimates.",
    ...
    "home.majors.business.specializations":
    ...
    "home.majors.liberal.specializations":
      "Literature, Philosophy, History, Linguistics, Cultural Studies",
    ...
    "home.majors.social.specializations":
      "Psychology, Political Science, Sociology, International Relations",
    ...
    "profile.hero.description":
      "Complete your academic and extracurricular profile to get a comprehensive profile score and personalized university recommendations.",
    ...
    "profile.checklist.description":
      "Check the items you have completed or possess. This helps assess your application readiness.\nNot all items are required and requirements may vary by school.",
    ...
    "profile.non-academic.essay.placeholder":
    ...
    "profile.extracurriculars.grades":
      "Grade Participation (select all that apply)",
    ...
    "profile.extracurriculars.empty":
    ...
    "profile.recommendations.relevance.highly":
    ...
    "profile.comparison.no-results.action":
      "Try searching with a different name.",
    "profile.comparison.empty":
      "Complete your profile to view comparison results.",

    // Housing Page
    "housing.hero.subtitle": "Searching for your Dream Home",
    "housing.hero.title": "Find Your Perfect Home Near Campus.",
    "housing.hero.description":
      "Browse all listings near your university at a glance!\nFind your ideal home online, easily and conveniently.",
    "housing.hero.button": "Find Properties Now",
    "housing.availability.notice":
      "Currently available in California and Georgia only",
    ...
    "housing.search.placeholder":
      "e.g., Los Angeles, Atlanta, Fresno, Savannah",
    "housing.search.error.invalid-state":
      "Sorry, listings are currently available only in California (CA) and Georgia (GA).",
    "housing.search.error.examples":
      "Examples: Fresno, Los Angeles, San Francisco (CA) • Atlanta, Savannah, Athens (GA)",
    ...
    "housing.empty.description":
      "Listings are currently available in California and Georgia only.",
    "housing.empty.examples":
      "California: Fresno, Los Angeles, San Francisco, San Diego, Sacramento",
    "housing.empty.examples.ga":
      "Georgia: Atlanta, Savannah, Athens, Augusta, Columbus",
    "housing.features.title": "Easier and Faster Way to Find Housing",
    "housing.features.location.title": "Curated Near Universities",
    "housing.features.location.description":
      "Search by university location and automatically filter for properties near campus.\nFind only the homes you need instead of thousands of irrelevant listings.",
    "housing.features.search.title": "Search by Your Preferences",
    "housing.features.search.description":
      "Select your preferred criteria like budget, bedrooms, distance, and property type to see only matching listings.\nFind your perfect home with just a few clicks without complex searches.",
    "housing.features.expert.title": "Expert Consultation for First-Timers",
    "housing.features.expert.description":
      "Finding housing in the U.S. for the first time and feeling overwhelmed? Get convenient consultation with local real estate experts via KakaoTalk.",

    // Universities Page
    "universities.title": "Find Universities",
    "universities.description":
      "Browse U.S. universities and find schools that match your profile.",
    ...
    "universities.empty.description":
      "Try resetting the filters or search again.",
    ...
    "auth.description":
      "Sign in to save your profile and track your college journey",
    ...
    "dashboard.subtitle":
      "Your personalized college admission analysis and recommendations.",
    "dashboard.empty.title": "Complete Your Profile",
    "dashboard.empty.desc":
      "To see personalized university recommendations, please complete your academic profile first.",
    ...
    "dashboard.improve.desc":
      "Focus on improving these areas to increase your admission chances.",
    "dashboard.improve.excellent":
      "Excellent! Your profile looks strong across all areas.",
    ...
    "dashboard.profileHistory.title": "Profile Analysis History",
    "dashboard.profileHistory.subtitle": "Your most recent profile inputs",
    "dashboard.profileHistory.academic": "Academic Profile",
    "dashboard.profileHistory.extracurricular": "Extracurricular Profile",
    "dashboard.profileHistory.total": "Total",
    "dashboard.profileHistory.courses": "courses",
    "dashboard.profileHistory.activities": "activities",
    "dashboard.profileHistory.recommendations": "Recommendations",
    "dashboard.profileHistory.letters": "letters",
    "dashboard.profileHistory.positions": "positions",
    "dashboard.profileHistory.awards": "Awards",
    "dashboard.profileHistory.awardsCount": "awards",
    "dashboard.profileHistory.citizenship": "Status",
    "dashboard.profileHistory.domestic": "Domestic",
    "dashboard.profileHistory.international": "International",
  },
};
